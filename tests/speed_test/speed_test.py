...
def c_test():
    c_program = timeit(lambda: c_import("tests/speed_test.c"))
...
def cpp_test():
    cpp_program = timeit(lambda: c_import("tests/speed_test.cpp"))
...
def rust_test():
    rust_program = timeit(lambda: rust_import("tests/speed_test.rs"))
